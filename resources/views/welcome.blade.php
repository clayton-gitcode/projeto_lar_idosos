            ...
            <div class="hero min-h-[60vh] bg-base-100">
                <div class="hero-content text-center">
                    <div class="max-w-md">
                        ...
                        <p class="py-6">Simplifique a administração, centralize informações dos moradores e ofereça o melhor cuidado com um sistema pensado para as suas necessidades.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body items-center">
                            ...
                            <h3 class="card-title mt-4">Gestão de moradores</h3>
                    ...
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body items-center">
                            ...
                            <p>Visualize rapidamente a lista de moradores, faça buscas e acesse os perfis com poucos cliques.</p>
                        </div>
                    </div>
                    <div class="card bg-base-100 shadow-xl">
                        <div class="card-body items-center">
