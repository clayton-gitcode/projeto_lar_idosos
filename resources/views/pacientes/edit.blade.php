                ...
                <form action="{{ route('pacientes.edit', $paciente ) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="form-control">
                            <label class="label"><span class="label-text">Foto do Paciente</span></label>
                        ...
                        <div class="form-control lg:col-span-2">
                            ...
                            <input type="text" name="name" placeholder="Nome completo" value="{{old('name', $paciente->name)}}" class="input input-bordered w-full @error('name') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="date" name="birth_date" value="{{old('birth_date', $paciente->birth_date)}}" class="input input-bordered w-full @error('birth_date') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" name="age" placeholder="Idade" value="{{old('age',$paciente->age)}}" class="input input-bordered w-full @error('age') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <div class="flex items-center gap-4">
                                <label class="label cursor-pointer gap-2">
                                    <input type="radio" name="sexo" value="M" class="radio radio-primary" {{ old('sexo', $paciente->sexo) == 'M' ? 'checked' : '' }} />
                                    <span class="label-text">Masculino</span> 
                                </label>
                                <label class="label cursor-pointer gap-2">
                                    <input type="radio" name="sexo" value="F" class="radio radio-primary" {{ old('sexo', $paciente->sexo) == 'F' ? 'checked' : '' }} />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="rg" placeholder="MG 00.000.000" value="{{old('rg', $paciente->rg)}}" class="input input-bordered w-full @error('rg') input-error @enderror" />
                             @error('rg')<span class="mt-1 text-xs text-error">{{ $message }}</span>@enderror
                        </div>
                        
                        <div class="form-control">
                            <label class="label"><span class="label-text">CPF</span></label>
                            <input type="text" name="cpf" placeholder="000.000.000-00" value="{{old('cpf', $paciente->cpf)}}" class="input input-bordered w-full @error('cpf') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="sus" placeholder="Nº do cartão do SUS" value="{{old('sus', $paciente->sus)}}" class="input input-bordered w-full @error('sus') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="responsavel" placeholder="Nome completo" value="{{old('responsavel', $paciente->responsavel)}}" class="input input-bordered w-full @error('responsavel') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="doc_resp" placeholder="RG ou CPF" value="{{old('doc_resp', $paciente->doc_resp)}}" class="input input-bordered w-full @error('doc_resp') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="telefone_resp" placeholder="(00) 90000-0000" value="{{old('telefone_resp', $paciente->telefone_resp)}}" class="input input-bordered w-full @error('telefone_resp') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="banco" placeholder="Nome do banco" value="{{old('banco', $paciente->banco)}}" class="input input-bordered w-full @error('banco') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="tipo_beneficio" placeholder="Ex: Aposentadoria, Pensão" value="{{old('tipo_beneficio', $paciente->tipo_beneficio )}}" class="input input-bordered w-full @error('tipo_beneficio') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" name="valor_mensal" placeholder="R$ 0,00" value="{{old('valor_mensal', $paciente->valor_mensal )}}" class="input input-bordered w-full @error('valor_mensal') input-error @enderror" />
                        ...
                        <div class="form-control">
                            ...
                            <input type="date" name="data_recebimento" value="{{old('data_recebimento', $paciente->data_recebimento)}}" class="input input-bordered w-full @error('data_recebimento') input-error @enderror" />
                        ...
                        <div class="form-control col-span-full">
                            ...
                            <textarea name="obs" placeholder="Alguma observação importante..." class="textarea textarea-bordered h-24 @error('obs') textarea-error @enderror">{{old('obs', $paciente->obs)}}</textarea>
                    ...
                    <div class="card-actions mt-8 justify-end">
                        <a href="{{ route('pacientes.list') }}" class="btn btn-ghost">Cancelar</a>
